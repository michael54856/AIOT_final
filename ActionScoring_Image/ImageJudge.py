...
posePosition = generatePosition("outputJson/Compare_keypoints.json") #取得比對的position

targetVector = generateVector("outputJson/Sample_keypoints.json") #取得比對的向量資訊
targetPosition = generatePosition("outputJson/Sample_keypoints.json") #取得比對的position
...
output_fileName = "compareVector.png"
